# 🏗️ System Design Curriculum for Data Engineers

> A 12-week journey from fundamentals to interview mastery — built in four phases.
...
| Phase | Weeks | Focus |
|-------|-------|-------|
| **Phase 1** | 1–3 | Foundations |
| **Phase 2** | 4–7 | Data Engineering Core |
| **Phase 3** | 8–9 | Pipelines, Modeling & Operations |
| **Phase 4** | 10–12 | Interview Mastery |
...
> 🎯 **Drill-heavy week.** I'll make you estimate:
> - Swiggy's order QPS
> - Hotstar's bandwidth during IPL finals
> - PhonePe's transaction storage per year
...
## ⚙️ Phase 3: Pipelines, Modeling & Operations (Weeks 8–9)
...
- 🗣️ Communicating trade-offs like a senior engineer, **not reciting facts**
...
- ✅ You can estimate any system's QPS / storage on a whiteboard in under 2 minutes
- ✅ You can defend every architectural choice with concrete trade-offs
- ✅ You can pivot mid-interview when the interviewer challenges an assumption
- ✅ You can say *"I don't know, but here's how I'd find out"* — and mean it

---

> 🧠 **Remember:** Senior interviews aren't about knowing every tool. They're about **thinking clearly under pressure** and **communicating trade-offs like an engineer who's shipped real systems.**
